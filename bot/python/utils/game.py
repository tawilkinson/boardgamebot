...
class Webpage(BeautifulSoup):
    ...
    def __init__(self, url, xml=False, headers=None):
        try:
...
class Game:
    ...
    tabletopia.com, steamcommunity.com (for table top simulator games) and yucata.de.
    ...
    def __init__(self, name):
        ...
        self.bgg = ""
        self.bgg_search_url = f"https://boardgamegeek.com/xmlapi2/search?query={self.search_name}&exact=1&type=boardgame"
        self.bgg_non_exact_search_url = f"https://boardgamegeek.com/xmlapi2/search?query={self.search_name}&type=boardgame"
    ...
    def get_set_bgg_url(self, game_id):
        ...
        return f"https://boardgamegeek.com/xmlapi2/thing?id={game_id}"
